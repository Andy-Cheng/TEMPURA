            ...
            <ContentInner>
                ...
                <Paragraph>
                    ...
                    <Timeline mode="alternate">
                        <Timeline.Item dot={<HomeOutlined style={{ fontSize: '14px' }} />}>
                        ...
                        <Timeline.Item dot={<FileOutlined style={{ fontSize: '14px' }} />}>
                            <Typography.Text style={{ color: "orange" }}>
                        ...
                        <Timeline.Item dot={<LikeOutlined style={{ fontSize: '14px', color: "green" }} />}>
                            <Typography.Text >
